...
def _get_wxai_client():
    ...
    # Add this line to set the default space or project
    # Get your SPACE_UID or PROJECT_UID from your WatsonX.ai instance
    SPACE_ID = os.getenv("WATSONX_SPACE_ID")  # Add this to your .env file
