...
# # OAuth token & credentials (created by get_calendar_token.py)
# CAL_SCOPES = [
#     "https://www.googleapis.com/auth/calendar.events",
#     "https://www.googleapis.com/auth/gmail.send",
# ]
# CAL_TOKEN_FILE = "calendar_token.json"          # created by get_calendar_token.py
# CAL_CREDENTIALS_FILE = "calendar_credentials.json"  # used only by the token script

# TIMEZONE = os.getenv("TIMEZONE", "Asia/Jakarta")
# GOOGLE_CALENDAR_ID = "primary"                  # primary calendar of OAuth user

# # Email "From" (should match the OAuth account or alias)
# FROM_EMAIL = os.getenv("FROM_EMAIL", "watsonxincubation@gmail.com")


# # --------------------------------------------------------------------
# # Google API helpers (shared creds for Calendar + Gmail)
# # --------------------------------------------------------------------

# def get_user_creds():
#     """
#     Load OAuth credentials for the Gmail/Calendar user.
#     Uses calendar_token.json generated by get_calendar_token.py.
#     """
#     if not os.path.exists(CAL_TOKEN_FILE):
#         raise RuntimeError(
#             "calendar_token.json not found. Run get_calendar_token.py first."
#         )
...
#         else:
#             raise RuntimeError(
#                 "Calendar/Gmail credentials invalid. "
#                 "Delete calendar_token.json and run get_calendar_token.py again."
#             )
#     return creds
...
#     subject: str
#     body: str
#     cc: Optional[str] = None   # comma-separated emails
#     bcc: Optional[str] = None  # comma-separated emails
...
# app = FastAPI(
#     title="Gmail & Calendar API (OAuth only)",
#     version="1.0.0",
# )
...
#     """
#     Build MIMEText message for Gmail API.
#     """
...
#     """
#     Convert 'YYYY-MM-DD' + 'HH:MM' into ISO datetimes for Calendar.
#     Adds 1 hour duration by default.
#     """
...
#     """
#     Send email via Gmail API using the same OAuth token as Calendar.
#     """
#     try:
...
#     (e.g. watsonxincubation@gmail.com), with optional attendees and Meet link.
#     """
#     try:
